...
export const BrainCircuitIcon: React.FC<IconProps> = ({
  className = "w-6 h-6",
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const LightbulbIcon: React.FC<IconProps> = ({
  ...
  <svg
    ...
    className={className}
  >
    <path d="M9 18h6M12 2a7 7 0 0 0-7 7c0 3.03 1.9 5.58 4.5 6.55L12 22v-2.5a7 7 0 0 0 7-7 7 7 0 0 0-7-7z"></path>
  </svg>
);
