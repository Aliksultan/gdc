...
export const ExplorePage = () => {
  ...
  const careerTitle = user.role
    ? user.role.replace("Aspiring ", "")
    : "Product Manager";
  ...
  return (
    <main className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 animate-fade-in">
      <div className="flex flex-col gap-8">
        ...
        {aiRecommendations && (
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card className="animate-fade-in bg-gradient-to-br from-primary/5 to-blue-500/5 border-primary/20">
              ...
              <CardContent>
                <ul className="space-y-2">
                  {aiRecommendations.learningPaths
                    ?.slice(0, 3)
            ...
            <Card className="animate-fade-in bg-gradient-to-br from-primary/5 to-purple-500/5 border-primary/20">
              ...
              <CardContent>
                <ul className="space-y-3">
                  {aiRecommendations.skillPriorities
                    ?.slice(0, 3)
            ...
            <Card className="animate-fade-in bg-gradient-to-br from-primary/5 to-orange-500/5 border-primary/20">
              ...
              <CardContent>
                <ul className="space-y-2">
                  {aiRecommendations.similarRoles
                    ?.slice(0, 3)
        ...
        <Accordion
          type="multiple"
          defaultValue={["responsibilities", "skills"]}
          className="space-y-4"
        >
          {/* Key Responsibilities */}
          <AccordionItem
            value="responsibilities"
            className="border rounded-xl bg-card px-5"
          >
            ...
            <AccordionContent className="space-y-3 text-sm text-muted-foreground">
              <p>
                A Product Manager's daily tasks involve a blend of strategic
                planning, market research, and team collaboration. Key
              ...
              <ul className="space-y-2 pl-5 list-disc">
                ...
                <li>
                  Working closely with engineering, sales, marketing, and
                  support to ensure revenue and customer satisfaction goals are
                  met.
                </li>
                <li>
                  Defining the 'why', 'what,' and 'when' of the product that the
          ...
          >
            ...
            <AccordionContent className="space-y-4 text-sm text-muted-foreground pt-2">
              <p>
                Salaries for Product Managers vary based on experience,
                location, and company size. The typical range in the US is shown
                below.
              </p>
